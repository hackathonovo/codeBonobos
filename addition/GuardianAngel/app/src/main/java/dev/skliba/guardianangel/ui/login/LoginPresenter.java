...
import dev.skliba.guardianangel.data.managers.FacebookSessionNotInProgress;
import dev.skliba.guardianangel.data.managers.LoginListener;
    ...
    public void onFacebookLoginClicked(FacebookManager facebookManager) {
        facebookManager.login(new LoginListener() {
            ...
            public void onSuccess(String accessToken) {
                SharedPrefsUtil.storeToken(accessToken);
                view.navigateToMain();
                //interactor.facebookLogin(accessToken, listener);
            }
